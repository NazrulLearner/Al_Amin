...
export default function Sidebar({}: SidebarProps) {
  ...
  // Get current user role from active organization or super admin
  ...
  // Get member ID for current organization
  ...
  const getMenuItems = (): MenuItem[] => {
    if (currentUserRole === 'super_admin') {
      return [
        ...
        },
        {
          ...
          path: "/super-admin/CreateOrganization",
          roles: ['super_admin'] as UserRole[]
        },
        {
    ...
    if (['admin', 'cashier'].includes(currentUserRole)) {
      baseMenu.push({
        ...
        children: [
          ...
          { name: "Fee Reports", path: "/fees/reports", roles: ['admin'] as UserRole[] },
    ...
    baseMenu.push({
      ...
      icon: <HelpCircle size={18} />,
      children: [
        { name: "Support Home", path: "/support/index", roles: ['admin', 'cashier', 'member'] as UserRole[] },
        { name: "FAQ", path: "/support/faq", roles: ['admin', 'cashier', 'member'] as UserRole[] },
        { name: "About", path: "/support/about", roles: ['admin', 'cashier', 'member'] as UserRole[] },
      ],
      roles: ['admin', 'cashier', 'member'] as UserRole[]
    });
